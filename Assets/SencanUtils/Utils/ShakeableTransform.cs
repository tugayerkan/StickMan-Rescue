...
namespace SencanUtils
{
    public class ShakeableTransform : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] private Vector3 maximumTranslationShake = Vector3.one;

        /// <summary>
        /// Maximum angle, in degrees, the transform will rotate
        /// during shaking.
        /// </summary>
        [SerializeField] private Vector3 maximumAngularShake = Vector3.one * 15;
        ...
        /// </summary>
        [SerializeField] private float traumaExponent = 1;
